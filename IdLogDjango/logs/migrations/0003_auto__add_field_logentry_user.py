...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('logs_logentry', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='entry', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LogEntry.user'
        db.delete_column('logs_logentry', 'user_id')
    ...
    models = {
        ...
        'logs.logentry': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'entry'", 'to': "orm['auth.User']"})
        },
        'logs.relation': {
